...
import { 
  ...
  MessageSquare, ArrowRight, Crown, Lock, Ticket, X, Gift, Sparkles
} from "lucide-react";
...
export default function BookingForm() {
  ...
  const handleInitialPayment = async () => {
    ...
    try {
      ...
      if (paymentData?.final_amount === 0 || res.data.isFree) {
        toast.success("Darshan Secured! Pass activated.");
      ...
      if (!rzpKey || !rzpOrderId) {
        toast.error("Gateway error: Missing keys.");
        setSubmitting(false);
        return;
      }
